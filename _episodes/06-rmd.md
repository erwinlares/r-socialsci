...
~~~
Error: 'data/interviews_plotting.csv' does not exist in current working directory ('/home/runner/work/r-socialsci/r-socialsci/_episodes_rmd').
~~~
{: .error}
...
~~~
Error in glimpse(interviews_plotting): object 'interviews_plotting' not found
~~~
{: .error}
...
~~~
Error in select(., village, no_membrs): object 'interviews_plotting' not found
~~~
{: .error}
...
~~~
Error in include_graphics("~/Desktop/dissertation/images/rmarkdownflow.png"): Cannot find the file(s): "~/Desktop/dissertation/images/rmarkdownflow.png"
~~~
{: .error}
