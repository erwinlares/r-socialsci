...
Of the three villages surveyed, `r pop_results$villlage[3]` is the most populated with `r pop_results$population[3]` people. The second-most populated village is God with 295 people. The least populated village in the sample is Chirodzo with 276. 



> ## Add your own inline code
>
> Challenge. Modify the rest of the paragraph so that the rest of the villages and their population appear in the text. Start using the code below to ensure you have the R object `pop_result`.
>
> ~~~
> pop_results <- interviews_plotting %>% select(village,
                               no_membrs) %>% 
...
> > ## Solution
> >
> > Of the three villages surveyed, ~~~r pop_results$villlage[3]~~~ is the most populated with ~~~r pop_results$population[3]~~~ people. The second-most populated village is ~~~r pop_results$villlage[2]~~~ with ~~~r pop_results$population[3]~~~ people. The least populated village in the sample ~~~r pop_results$villlage[1]~~~ with ~~~r pop_results$population[1]~~~.
> >
> {: .solution}
{: .challenge}
...
include_graphics("~/Desktop/dissertation/images/rmarkdownflow.png")
