...
> > populated with `r pop_results$population[3]` people. The second-most populated 
> > village is `r pop_results$villlage[2]` with `r pop_results$population[3]` 
> > people. The least populated village in the sample `r pop_results$villlage[1]` 
> > with `r pop_results$population[1]`.
> >
> {: .solution}
{: .challenge}
