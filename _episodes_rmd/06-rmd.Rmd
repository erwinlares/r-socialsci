...
**Version A: manually created the document**
...
Of the three villages surveyed, `r pop_results$villlage[3]` is the most populated with `r pop_results$population[3]` people.
